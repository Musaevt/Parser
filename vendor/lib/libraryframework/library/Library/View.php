...
class View {
    ...
    function __construct($module_name) {
        ...
        $this->resources = require Q_PATH.$this->config['resource_options']['path'];
    }
   public function includePage() {
    ...
    public function includeModuleView($view) {
        ...
        if ($view) {
            $this->includeFile($this->module_path.'/view/'.$view['path'].'.tpl.php');
        }
    }
...
////  
        ...
        $view = isset($this->general_includes['views'][$view])
         ...
         if ($view) {
            ...
            $this->includeFile($this->common_view_path.'/'.$view['path'].'.tpl.php');
        }
    }
