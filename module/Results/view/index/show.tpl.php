    ...
    <div class="graph">
     ...
     <div class="chart_description">
         <h3>Описание Графика 2</h3>
                <p>В графике №2 ось Y обозначает количество пользователей в группе.
                   На оси X изображенны названия групп(screen names), отсортированные по убыванию количества подписчиков.
                </p>
     </div>
     </div>
     <div class="graph">
         ...
         <div class="chart_description">
                ...
                <p>В графике №3 ось Y обозначает количество групп пользователя.
                   На оси Y представленны подписчики исходной группы.                   
                </p>
